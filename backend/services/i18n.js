...
const STRINGS = {
  ...
  directions_cta_body: {
    en: '📍 Tap below to navigate to the hospital.',
    te: '📍 హాస్పిటల్‌కు దారి కోసం కింద నొక్కండి.',
  },
  appt_generating: {
    en: '⏳ Your appointment is being confirmed. Please wait a moment…',
    te: '⏳ మీ అపాయింట్‌మెంట్ నిర్ధారించబడుతోంది. దయచేసి కొంచెం వేచి ఉండండి…',
  },
